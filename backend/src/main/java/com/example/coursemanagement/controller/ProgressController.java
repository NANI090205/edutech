...
public class ProgressController {
    ...
    public ResponseEntity<ProgressDTO> getProgress(@PathVariable Long courseId,
    ...
    public ResponseEntity<Map<String, String>> complete(@RequestBody Map<String, Long> payload,
                                                        @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseEntity<Map<String, String>> incomplete(@RequestBody Map<String, Long> payload,
                                                          @AuthenticationPrincipal UserDetailsImpl userDetails) {
        Long lessonId = payload.get("lessonId");
